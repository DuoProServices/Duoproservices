...
# 🎯 Script de Setup Automático - DuoPro Services
# Este script configura Git e faz push para o GitHub automaticamente
...
- Complete trilingual internationalization (EN/FR/PT)
- Supabase integration with authentication
- Client portal with visual timeline
...
# Renomear branch para main (caso seja master)
